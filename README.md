...
```
$ oc login
$ export OPENSHIFT_CLUSTER_SEED=/path/to/openshift-applier/playbooks/openshift-cluster-seed.yml
$ ansible-playbook -i ./applier/inventory/ ${OPENSHIFT_CLUSTER_SEED}
```
